...
function updateJobStatusModal() {
	...
	$.getJSON("/jobStatus/" + jobId , function(data) {
		$( "#jobStatusModal").find( ".modal-body" ).html( "<p>Current Job State: <span class=\"job_" + data + "\">" + data + "</span><img class=\"pull-right\" id=\"jobStatusLoader\" src=\"/assets/img/ajax-loader.gif\"></p>" );
